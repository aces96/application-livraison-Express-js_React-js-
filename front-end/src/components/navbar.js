    ...
    return (<AppBar position='fixed' sx={{backgroundColor: "#323232"}}>
                <Toolbar sx={{height: "100%"}}>
                    ...
                    <Box sx={{flexGrow: 1, display: { xs: 'none', md: 'flex' }, justifyContent:'end',height:"100%" }}>
                        <Button  sx={{ my: 2, color: 'white', display: 'block',fontFamily: 'Roboto, sans-serif' }}>Menu</Button>
                        <Button sx={{ my: 2, color: 'white', display: 'block', fontFamily: 'Roboto, sans-serif' }}>Category</Button>
                    </Box>
